...
from .hardware_link_manager import HardwareLinkManager # <-- Add this import
...
from .dialogs import FindItemDialog, SettingsDialog, SubFSMEditorDialog
from .fsm_simulator import FSMSimulator, FSMError # This is now correct
from .git_manager import GitManager
from .perspective_manager import PerspectiveManager
from .custom_widgets import CollapsibleSection, DraggableToolButton
...
# ...existing code...
    ...
    def on_item_edit_requested(self, item: QGraphicsItem):
        ...
        from .dialogs import StatePropertiesDialog, TransitionPropertiesDialog, CommentPropertiesDialog # Local import is fine here
    ...
    def on_matlab_settings(self, checked=False): 
        from .dialogs import MatlabSettingsDialog # Local import to avoid circular dep
