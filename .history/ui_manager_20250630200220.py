...
from PyQt5.QtGui import QIcon, QKeySequence, QPalette, QPainter, QColor
...
class UIManager(QObject): 
    ...
    def _populate_elements_palette_dock(self):
        ...
        manage_templates_btn.clicked.connect(self.mw.action_handler.on_manage_fsm_templates)
