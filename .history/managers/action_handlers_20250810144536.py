...
# Note: Other direct imports are removed as logic moves to sub-handlers
...
class ActionHandler(QObject):
    ...
    def connect_actions(self):
        ...
        self.mw.export_png_action.triggered.connect(self.file_handler.on_export_png) # Image export is a file op
        self.mw.export_svg_action.triggered.connect(self.file_handler.on_export_svg) # Image export is a file op
    ...
    # Methods that need to be called from MainWindow, delegated to the appropriate sub-handler.
