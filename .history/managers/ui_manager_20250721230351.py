...
class UIManager(QObject): 
    ...
    def _create_ribbon(self):
        ...
        # --- START OF FIX: Replace ToolBar with setMenuWidget ---
        # Instead of putting the ribbon in a toolbar, set it as the menu widget.
        mw.setMenuWidget(mw.ribbon)
        # --- END OF FIX ---
        
        # --- Setup the Menus that will be used by the Ribbon's buttons ---
        mw.view_menu = QMenu("&View", mw)
        # --- START OF FIX: Remove the now-obsolete 'Toolbars' menu ---
        # This menu was for toggling the old toolbar container, which is no longer used.
