...
class ActionHandler(QObject):
    ...
    # --- NEW METHODS for the Scratchpad ---
    ...
    def _on_scratchpad_revert(self):
        ...
        if reply == QMessageBox.Yes:
            self.mw._update_live_preview() # This method regenerates the code
            self.mw.scratchpad_sync_action.setEnabled(False) # Changes are gone
    ...
    def on_export_simulink(self):
        ...
        # --- MODIFICATION: Remove the connection check ---
        ...
        # --- MODIFICATION: The call now handles connection transparently ---
