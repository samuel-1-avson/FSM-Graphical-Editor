...
class IDEManager(QObject):
    ...
    def __init__(self, main_window):
        ...
        # --- FIX: Defer UI setup. These will be called from MainWindow after docks are created. ---
    ...
    # --- FIX: Renamed this method to be called from MainWindow after UI setup ---
    ...
    def _show_ide_context_menu(self, pos):
        ...
        # --- AI IMPROVEMENT: Add "Analyze Selection" action ---
    ...
    def _connect_ide_actions(self):
        ...
        # --- AI IMPROVEMENT: Connect new action ---
        if hasattr(self.mw, 'ide_analyze_selection_action'):
