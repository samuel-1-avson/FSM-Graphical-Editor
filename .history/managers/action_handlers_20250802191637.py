...
class ActionHandler(QObject):
    ...
    def on_export_simulink(self):
        ...
        if not self.mw.matlab_connection.is_connected():
            QMessageBox.warning(self.mw, "MATLAB Not Connected", "Could not connect to the MATLAB Engine. Please check your installation and settings.")
            return
        ...
        # --- FASTER WORKFLOW: No dialog needed, export is quick ---
