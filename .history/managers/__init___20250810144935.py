...
# Note: ResourceMonitorManager has been moved to the 'services' package.
...
from .matlab_simulation_manager import MatlabSimulationManager
from .data_dictionary_manager import DataDictionaryManager
from .c_simulation_manager import CSimulationManager
from .signal_bus import signal_bus
from .asset_manager import AssetManager # <-- Renamed from CustomSnippetManager
...
__all__ = [
    ...
    "CSimulationManager",
    "signal_bus",
    "AssetManager", # <-- Export the new name
]