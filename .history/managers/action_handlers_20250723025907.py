...
from PyQt5.QtCore import QObject, pyqtSlot, QDir, QUrl, QPointF, Qt, QRectF, QSizeF, QDateTime, QFile, QIODevice, QModelIndex, QVariant, QTimer, QEvent, QPoint, QCoreApplication
