...
from .graphics_scene import DiagramScene, ZoomableView, MinimapView
...
from .dialogs import FindItemDialog, SettingsDialog, MatlabSettingsDialog
from .git_manager import GitManager
from .perspective_manager import PerspectiveManager
from .custom_widgets import CollapsibleSection
from .resource_estimator import ResourceEstimator

# Import code generation and export functions
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.ui_manager.setup_ui() # Creates all menus, docks, and toolbars
        ...
        logger.info(f"{APP_NAME} v{APP_VERSION} initialization complete.")
    ...
    def _connect_application_signals(self):
        ...
        if hasattr(self, 'problems_list_widget'): self.problems_list_widget.itemDoubleClicked.connect(self.on_problem_item_double_clicked)
...
Please explain what this means in the context of an FSM and suggest how I might fix it. Be concise."""
    ...
    def _update_window_title(self):
        ...
        pysim_suffix = " [PySim Active]" if editor.py_sim_active else ""
