...
class ModernRibbon(QWidget):
    ...
    def create_home_tab(self):
        ...
        new_btn = RibbonButton("New", get_standard_icon("SP_FileIcon"))
        new_btn.clicked.connect(self.newFileRequested.emit)
        file_group.add_button(new_btn)
        
        open_btn = RibbonButton("Open", get_standard_icon("SP_DialogOpenButton"))
        open_btn.clicked.connect(self.openFileRequested.emit)
        file_group.add_button(open_btn)
        
        save_btn = RibbonButton("Save", get_standard_icon("SP_DialogSaveButton"))
        ...
        cut_btn = RibbonButton("Cut", get_standard_icon("SP_DialogCancelButton"))
        clipboard_group.add_button(cut_btn)
        
        copy_btn = RibbonButton("Copy", get_standard_icon("SP_FileDialogDetailedView"))
        clipboard_group.add_button(copy_btn)
        
        paste_btn = RibbonButton("Paste", get_standard_icon("SP_DialogApplyButton"))
    ...
    def create_design_tab(self):
        ...
        comment_btn = RibbonButton("Comment", get_standard_icon("SP_MessageBoxInformation"))
        ...
        align_left_btn = RibbonButton("Align Left", get_standard_icon("SP_ArrowLeft"))
        layout_group.add_button(align_left_btn)
        
        align_center_btn = RibbonButton("Center", get_standard_icon("SP_DialogResetButton"))
        layout_group.add_button(align_center_btn)
        
        align_right_btn = RibbonButton("Align Right", get_standard_icon("SP_ArrowRight"))
    ...
    def create_simulation_tab(self):
        ...
        play_btn = RibbonButton("Start", get_standard_icon("SP_MediaPlay"))
        control_group.add_button(play_btn)
        
        pause_btn = RibbonButton("Pause", get_standard_icon("SP_MediaPause"))
        control_group.add_button(pause_btn)
        
        stop_btn = RibbonButton("Stop", get_standard_icon("SP_MediaStop"))
        control_group.add_button(stop_btn)
        
        step_btn = RibbonButton("Step", get_standard_icon("SP_ArrowForward"))
    ...
    def create_view_tab(self):
        ...
        zoom_in_btn = RibbonButton("Zoom In", get_standard_icon("SP_DialogYesButton"))
        zoom_in_btn.clicked.connect(lambda: self.zoomChanged.emit(120))
        zoom_group.add_button(zoom_in_btn)
        
        zoom_out_btn = RibbonButton("Zoom Out", get_standard_icon("SP_DialogNoButton"))
        ...
        grid_btn = RibbonButton("Grid", get_standard_icon("SP_FileDialogDetailedView"))
        grid_btn.setCheckable(True)
        grid_btn.setChecked(True)
        display_group.add_button(grid_btn)
        
        rulers_btn = RibbonButton("Rulers", get_standard_icon("SP_ToolBarHorizontalExtensionButton"))
        rulers_btn.setCheckable(True)
        display_group.add_button(rulers_btn)
        
        minimap_btn = RibbonButton("Minimap", get_standard_icon("SP_TitleBarNormalButton"))
