...
# --- START FIX ---
# ADD THE MISSING IMPORT FOR THE PARSER AND IR
...
# --- START FIX: Move imports to the top level ---
...
class MainWindow(QMainWindow):
    ...
    def on_item_edit_requested(self, item: QGraphicsItem):
        ...
        # --- FIX: The import is now at the top of the file, so we remove it from here. ---
        # from ..ui.dialogs import StatePropertiesDialog, TransitionPropertiesDialog, CommentPropertiesDialog # <--- REMOVE THIS LINE
