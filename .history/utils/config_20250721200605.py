# fsm_designer_project/config.py
...
THEME_KEYS = [
    "COLOR_BACKGROUND_APP", "COLOR_BACKGROUND_LIGHT", "COLOR_BACKGROUND_MEDIUM", 
    ...
    "COLOR_ITEM_STATE_DEFAULT_BORDER", "COLOR_ITEM_TRANSITION_DEFAULT", "COLOR_ITEM_COMMENT_BG",
    "COLOR_ITEM_COMMENT_BORDER", "COLOR_GRID_MINOR", "COLOR_GRID_MAJOR",
...
# The following variables are dynamically populated by the function below.
# They are defined here to satisfy linters and static analysis tools.
