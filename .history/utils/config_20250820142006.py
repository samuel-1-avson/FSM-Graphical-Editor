...
# --- NEW: Import the font helper ---
from .helpers import get_preferred_ui_font
...
# --- Fonts ---
# MODIFIED: Instead of a static string, we now call a function that finds
# the best available font on the current operating system.
APP_FONT_FAMILY = get_preferred_ui_font().family()
