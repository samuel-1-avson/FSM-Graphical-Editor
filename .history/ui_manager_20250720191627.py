...
class UIManager(QObject): 
    ...
    def _create_toolbars(self):
        ...
        file_group.add_widget(RibbonButton("New", mw.new_action.icon(), clicked=mw.new_action.trigger))
        file_group.add_widget(RibbonButton("Open", mw.open_action.icon(), clicked=mw.open_action.trigger))
        file_group.add_widget(RibbonButton("Save", mw.save_action.icon(), clicked=mw.save_action.trigger))
        file_tab.add_group(file_group)

        # Edit Tab
        edit_tab = mw.ribbon.add_tab("Edit")
        history_group = RibbonGroup("History")
        history_group.add_widget(RibbonButton("Undo", mw.undo_action.icon(), clicked=mw.undo_action.trigger))
        history_group.add_widget(RibbonButton("Redo", mw.redo_action.icon(), clicked=mw.redo_action.trigger))
        ...
        layout_group.add_widget(RibbonButton("Auto-Layout", mw.auto_layout_action.icon(), clicked=mw.auto_layout_action.trigger))
