...
class ActionHandler(QObject):
    ...
    def on_git_commit(self):
        ...
        if self.mw.current_editor().is_dirty():
        ...
        commit_message, ok = QInputDialog.getMultiLineText(self.mw, "Git Commit", "Enter commit message:")
