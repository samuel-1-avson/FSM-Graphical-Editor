...
# CORRECTED: Removed try-except blocks and using only robust relative imports.
...
# ...existing code...
    ...
    def _show_item_context_menu(self, item, event):
        ...
        # --- AI IMPROVEMENT: Contextual Explain action ---
        if self.parent_window and hasattr(self.parent_window, 'ai_chatbot_manager') and self.parent_window.ai_chatbot_manager.api_key:
