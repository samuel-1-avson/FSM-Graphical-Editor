...
class MainWindow(QMainWindow):
    ...
    def _update_live_preview(self):
        ...
        if preview_type == "PlantUML":
            ...
            from .c_code_generator import generate_c_code_content
            preview_text = generate_c_code_content(diagram_data) if diagram_data else ""
        elif preview_type == "Python Code":
            from .python_code_generator import generate_python_fsm_code
            preview_text = generate_python_fsm_code(diagram_data) if diagram_data else ""
        else:
            preview_text = "No preview available for this type."

        # Set the preview text in the appropriate widget
        if hasattr(self, 'live_preview_text_edit'):
            self.live_preview_text_edit.setPlainText(preview_text)
