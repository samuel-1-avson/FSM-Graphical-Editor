...
from .services import (
    MatlabConnection, ResourceMonitorManager, GitManager, HardwareLinkManager,
    EngineState, CommandType
)
from .managers import (
    SettingsManager, ThemeManager, UIManager, IDEManager, ActionHandler,
    PerspectiveManager, PluginManager, DataDictionaryManager, MatlabSimulationManager,
    CSimulationManager, signal_bus, AssetManager
)
from .codegen import (
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.welcome_widget.newFileRequested.connect(self.action_handler.file_handler.on_new_file)
        ...
        # --- FIX: MOVE THESE INITIALIZATIONS UP ---
