...
from .settings_manager import SettingsManager  # Import for type hinting
from .snippet_manager import CustomSnippetManager
from .fsm_simulator import FSMSimulator  # Import the simulator class for type hinting
...
class EditorWidget(QWidget):
    ...
    """
    def __init__(self, main_window_ref, custom_snippet_manager: CustomSnippetManager, settings_manager: SettingsManager):
        ...
        self.scene = DiagramScene(
            ...
            custom_snippet_manager=custom_snippet_manager, 
            settings_manager=settings_manager  # Pass the manager to the scene
        )
