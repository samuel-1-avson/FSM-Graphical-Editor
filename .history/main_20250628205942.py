...
class MainWindow(QMainWindow):
    ...
    def _connect_signals(self):
        ...
        if hasattr(self, 'save_perspective_action'): self.save_perspective_action.triggered.connect(self.save_current_perspective_as)
        if hasattr(self, 'reset_perspectives_action'): self.reset_perspectives_action.triggered.connect(self.reset_all_custom_perspectives)
