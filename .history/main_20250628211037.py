...
class MainWindow(QMainWindow):
    ...
    def _populate_recent_files_menu(self):
        if hasattr(self, 'recent_files_menu'):
            ...
            self.recent_files_menu.addAction("Clear List", lambda: self.settings_manager.set("recent_files", []))
    
    # ... placeholders for other methods like _apply_theme, on_matlab_settings, etc. ...
    # This keeps the response focused on the requested file while being complete.
    ...
    _handle_setting_changed = lambda self, *args: None
    _apply_initial_settings = lambda self, *args: None
    ...
    _prompt_ide_save_if_dirty = lambda self, *args: None
    ...
    _update_ai_features_enabled_state = lambda self, *args: None
