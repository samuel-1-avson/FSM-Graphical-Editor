...
from .core.matlab_integration import MatlabConnection, EngineState, CommandType
...
from .core.fsm_parser import parse_diagram_to_ir # Add this import
from .core.fsm_simulator import FSMSimulator
from .core.fsm_ir import FsmModel # Import for type hinting
try:
...
class MainWindow(QMainWindow):
    ...
    def _update_central_widget(self):
        ...
        if self.tab_widget.count() == 0:
            ...
            # --- FIX: Add safety check for sip.isdeleted ---
            if hasattr(self, 'welcome_widget') and not sip.isdeleted(self.welcome_widget) and hasattr(self.welcome_widget, 'update_recent_files'):
    ...
    def _update_matlab_status_display(self, state: EngineState, message: str):
        ...
        if hasattr(self, 'matlab_status_segment'):
            ...
            icon = QStyle.SP_ComputerIcon if is_connected else QStyle.SP_MessageBoxWarning
