...
class PySimulationUIManager(QObject):
    ...
    def on_sim_variable_changed(self, item: QTableWidgetItem): super().on_sim_variable_changed(item)
    @pyqtSlot()
    def on_start_py_simulation(self): super().on_start_py_simulation()
    @pyqtSlot()
    def on_trigger_py_event(self): super().on_trigger_py_event()
    @pyqtSlot()
    def on_continue_py_simulation(self): super().on_continue_py_simulation()