...
# Ensure COLOR_TEXT_EDITOR_DARK_PRIMARY is defined before stylesheet usage
if "COLOR_TEXT_EDITOR_DARK_PRIMARY" not in globals() or not globals()["COLOR_TEXT_EDITOR_DARK_PRIMARY"]:
    COLOR_TEXT_EDITOR_DARK_PRIMARY = THEME_DATA_LIGHT["COLOR_TEXT_EDITOR_DARK_PRIMARY"]

# Ensure COLOR_TEXT_EDITOR_DARK_SECONDARY is defined before stylesheet usage
if "COLOR_TEXT_EDITOR_DARK_SECONDARY" not in globals() or not globals()["COLOR_TEXT_EDITOR_DARK_SECONDARY"]:
    COLOR_TEXT_EDITOR_DARK_SECONDARY = THEME_DATA_LIGHT["COLOR_TEXT_EDITOR_DARK_SECONDARY"]

# Ensure COLOR_TEXT_ON_ACCENT is defined before stylesheet usage
if "COLOR_TEXT_ON_ACCENT" not in globals() or not globals()["COLOR_TEXT_ON_ACCENT"]:
    COLOR_TEXT_ON_ACCENT = THEME_DATA_LIGHT["COLOR_TEXT_ON_ACCENT"]

# Ensure COLOR_BACKGROUND_LIGHT is defined before stylesheet usage
if "COLOR_BACKGROUND_LIGHT" not in globals() or not globals()["COLOR_BACKGROUND_LIGHT"]:
    COLOR_BACKGROUND_LIGHT = THEME_DATA_LIGHT["COLOR_BACKGROUND_LIGHT"]

# Ensure COLOR_ACCENT_PRIMARY_LIGHT is defined before stylesheet usage
if "COLOR_ACCENT_PRIMARY_LIGHT" not in globals() or not globals()["COLOR_ACCENT_PRIMARY_LIGHT"]:
    COLOR_ACCENT_PRIMARY_LIGHT = THEME_DATA_LIGHT["COLOR_ACCENT_PRIMARY_LIGHT"]

# Ensure COLOR_BACKGROUND_DIALOG is defined before stylesheet usage
if "COLOR_BACKGROUND_DIALOG" not in globals() or not globals()["COLOR_BACKGROUND_DIALOG"]:
    COLOR_BACKGROUND_DIALOG = THEME_DATA_LIGHT["COLOR_BACKGROUND_DIALOG"]

# Ensure COLOR_BORDER_MEDIUM is defined before stylesheet usage
if "COLOR_BORDER_MEDIUM" not in globals() or not globals()["COLOR_BORDER_MEDIUM"]:
    COLOR_BORDER_MEDIUM = THEME_DATA_LIGHT["COLOR_BORDER_MEDIUM"]

# Ensure COLOR_ACCENT_PRIMARY is defined before stylesheet usage
if "COLOR_ACCENT_PRIMARY" not in globals() or not globals()["COLOR_ACCENT_PRIMARY"]:
    COLOR_ACCENT_PRIMARY = THEME_DATA_LIGHT["COLOR_ACCENT_PRIMARY"]

# Ensure COLOR_ACCENT_SECONDARY is defined before stylesheet usage
if "COLOR_ACCENT_SECONDARY" not in globals() or not globals()["COLOR_ACCENT_SECONDARY"]:
    COLOR_ACCENT_SECONDARY = THEME_DATA_LIGHT["COLOR_ACCENT_SECONDARY"]

# Ensure COLOR_BACKGROUND_EDITOR_DARK is defined before stylesheet usage
if "COLOR_BACKGROUND_EDITOR_DARK" not in globals() or not globals()["COLOR_BACKGROUND_EDITOR_DARK"]:
    COLOR_BACKGROUND_EDITOR_DARK = THEME_DATA_LIGHT["COLOR_BACKGROUND_EDITOR_DARK"]

# Ensure COLOR_BORDER_DARK is defined before stylesheet usage
if "COLOR_BORDER_DARK" not in globals() or not globals()["COLOR_BORDER_DARK"]:
    COLOR_BORDER_DARK = THEME_DATA_LIGHT["COLOR_BORDER_DARK"]
...
# Ensure COLOR_BORDER_LIGHT is defined before stylesheet usage
if "COLOR_BORDER_LIGHT" not in globals() or not globals()["COLOR_BORDER_LIGHT"]:
    COLOR_BORDER_LIGHT = THEME_DATA_LIGHT["COLOR_BORDER_LIGHT"]
...
# Ensure COLOR_BACKGROUND_DARK is defined for stylesheet generation
if "COLOR_BACKGROUND_DARK" not in globals() or not globals()["COLOR_BACKGROUND_DARK"]:
    COLOR_BACKGROUND_DARK = THEME_DATA_LIGHT["COLOR_BACKGROUND_DARK"]

# Ensure COLOR_TEXT_SECONDARY is defined for stylesheet generation
if "COLOR_TEXT_SECONDARY" not in globals() or not globals()["COLOR_TEXT_SECONDARY"]:
    COLOR_TEXT_SECONDARY = THEME_DATA_LIGHT["COLOR_TEXT_SECONDARY"]

# Ensure COLOR_ACCENT_ERROR is defined for stylesheet generation
if "COLOR_ACCENT_ERROR" not in globals() or not globals()["COLOR_ACCENT_ERROR"]:
    COLOR_ACCENT_ERROR = THEME_DATA_LIGHT["COLOR_ACCENT_ERROR"]

COLOR_ITEM_STATE_SELECTION_BG = ""
COLOR_ITEM_STATE_SELECTION_BORDER = ""
COLOR_ITEM_TRANSITION_SELECTION = ""
COLOR_DRAGGABLE_BUTTON_BG = THEME_DATA_LIGHT.get("COLOR_DRAGGABLE_BUTTON_BG", "#E8EAF6")
COLOR_DRAGGABLE_BUTTON_BORDER = THEME_DATA_LIGHT.get("COLOR_DRAGGABLE_BUTTON_BORDER", "#C5CAE9")
COLOR_DRAGGABLE_BUTTON_HOVER_BG = THEME_DATA_LIGHT.get("COLOR_DRAGGABLE_BUTTON_HOVER_BG", "#B9D9EB")
COLOR_DRAGGABLE_BUTTON_HOVER_BORDER = THEME_DATA_LIGHT.get("COLOR_DRAGGABLE_BUTTON_HOVER_BORDER", "#0277BD")
COLOR_DRAGGABLE_BUTTON_PRESSED_BG = THEME_DATA_LIGHT.get("COLOR_DRAGGABLE_BUTTON_PRESSED_BG", "#98BAD6")
