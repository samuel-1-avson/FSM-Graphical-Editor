...
class TransitionPropertiesDialog(QDialog):
    # --- BUG-01 FIX: Add 'ai_chat_ui_manager' to the constructor, now with a string type hint
    def __init__(self, custom_snippet_manager: CustomSnippetManager, ai_chat_ui_manager: 'AIChatUIManager | None', parent=None, current_properties=None, is_new_transition=False):
        super().__init__(parent)
