...
# Corrected: Added QGraphicsScene to imports to fix crash when opening Preferences.
...
from PyQt5.QtWidgets import (
    ...
    QApplication, QGraphicsScene # <--- ADDED QGraphicsScene HERE
)
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, settings_manager: SettingsManager, parent=None):
        ...
        # BUG FIX: Use QGraphicsView for preview
