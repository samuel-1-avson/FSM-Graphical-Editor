...
class RecentFileItem(QFrame):
    ...
    def init_ui(self):
        ...
        # File icon
        icon_label = QLabel()
        icon_label.setPixmap(get_standard_icon("SP_FileIcon").pixmap(32, 32))
        layout.addWidget(icon_label)
...
class ModernWelcomeScreen(QWidget):
    ...
    def create_action_cards(self, layout):
        ...
        open_card = ActionCard(
            ...
            get_standard_icon("SP_DialogOpenButton")
        )
        ...
        guide_card = ActionCard(
            ...
            get_standard_icon("SP_MessageBoxInformation")
        )
