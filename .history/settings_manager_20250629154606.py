...
class SettingsManager(QObject):
    ...
    DEFAULTS = {
        ...
        "canvas_grid_minor_color": "#ECEFF1",
        "canvas_grid_major_color": "#CFD8DC",
        "canvas_snap_guideline_color": "#ff0000",
        ...
        "item_default_state_color": "#E3F2FD", # Default state color setting
        ...
        "item_default_transition_color": "#00796B", # Default transition color setting

        "comment_default_font_family": "Segoe UI, Arial, sans-serif",
        "comment_default_font_size": 9,
        "comment_default_font_italic": True,
        "item_default_comment_bg_color": "#FFF9C4", # Default comment color setting
