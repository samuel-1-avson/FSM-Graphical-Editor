...
class StatePropertiesDialog(QDialog):
    ...
    def _on_ai_helper_clicked(self, target_widget, code_type):
        ...
        if not self.parent_window_ref or not hasattr(self.parent_window_ref, 'ai_chat_ui_manager'):
            QMessageBox.warning(self, "AI Not Available", "The AI assistant is not configured in the main window.")
            return
        ...
        self.parent_window_ref.ai_chat_ui_manager.handle_inline_ai_request(prompt, language)
