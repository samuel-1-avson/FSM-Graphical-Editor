...
class MainWindow(QMainWindow):
    ...
    def _connect_application_signals(self):
        ...
        if hasattr(self, 'project_tree_view'): self.project_tree_view.customContextMenuRequested.connect(self.action_handler.file_handler.on_project_explorer_context_menu)
        ...
        if self.py_sim_ui_manager:
            ...
            if hasattr(self.ai_chat_ui_manager, 'applyFixRequested'): self.ai_chat_ui_manager.applyFixRequested.connect(self.action_handler.edit_handler.apply_ai_fix)
