...
class TransitionPulseItem(QObject, QGraphicsEllipseItem):
    def __init__(self, parent_transition):
        # Initialize QObject without a parent (Qt parent)
        QObject.__init__(self)
        
        # Initialize QGraphicsEllipseItem with its dimensions
        # Do NOT pass parent_transition as parent here - set it after initialization
        QGraphicsEllipseItem.__init__(self, -5, -5, 10, 10)
        
        # Now set the parent item after both base classes are initialized
