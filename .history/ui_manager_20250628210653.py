...
from PyQt5.QtCore import Qt, QSize, QObject # <--- CORRECTED: Added QObject here
...
class UIManager(QObject): 
    def __init__(self, main_window: QMainWindow):
        ...
        self.mw = main_window
        self.elements_palette_dock = QDockWidget("Elements Palette", self)
    ...
    def _create_actions(self):
        ...
        mw.show_grid_action = QAction("Show Grid", mw, checkable=True, checked=True) # Added for menu
    ...
    def _create_menus(self):
        ...
        mw.recent_files_menu = self.recent_files_menu # Ensure MW has a direct ref
