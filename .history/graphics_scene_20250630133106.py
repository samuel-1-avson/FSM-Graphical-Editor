...
from PyQt5.QtCore import Qt, QRectF, QPointF, QLineF, pyqtSignal, QPoint, QMarginsF, QEvent, QMimeData, QTimer,QMainWindow
...
class DiagramScene(QGraphicsScene):
    ...
    def _show_item_context_menu(self, item, event):
        ...
        if self.parent_window and hasattr(self.parent_window, 'ai_chatbot_manager') and hasattr(self.parent_window.ai_chatbot_manager, 'api_key'):
        ...
        for i, item_info in enumerate(items_to_paste_data):
            ...
            if item_type == "State":
                ...
                new_item = GraphicsStateItem(
                    ...
                    shape_type=data.get('shape_type', self.settings_manager.get("state_default_shape")),
                    font_family=data.get('font_family', self.settings_manager.get("state_default_font_family")),
                    font_size=data.get('font_size', self.settings_manager.get("state_default_font_size")),
                    font_bold=data.get('font_bold', self.settings_manager.get("state_default_font_bold")),
                    font_italic=data.get('font_italic', self.settings_manager.get("state_default_font_italic")),
                    border_style_qt=SettingsManager.STRING_TO_QT_PEN_STYLE.get(data.get('border_style_str', self.settings_manager.get("state_default_border_style_str"))),
                    custom_border_width=data.get('border_width', self.settings_manager.get("state_default_border_width")),
                ...
                new_item = GraphicsCommentItem(
                    ...
                    font_family=data.get('font_family', self.settings_manager.get("comment_default_font_family")),
                    font_size=data.get('font_size', self.settings_manager.get("comment_default_font_size")),
                    font_italic=data.get('font_italic', self.settings_manager.get("comment_default_font_italic"))
                )
