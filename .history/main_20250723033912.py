...
class MainWindow(QMainWindow):
    ...
    def _connect_application_signals(self):
        ...
        # --- MODIFICATION: Connect scratchpad signals ---
...
# ...existing code...
    ...
    def _on_scratchpad_text_changed(self):
        """Enables the sync button when the scratchpad text is modified by the user."""
        if hasattr(self, 'scratchpad_sync_action'):
            self.scratchpad_sync_action.setEnabled(True)
        if hasattr(self, 'live_preview_editor'):
            # Provide a visual cue that the editor is out of sync with the diagram
