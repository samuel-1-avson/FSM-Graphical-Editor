...
from ..utils.helpers import get_standard_icon, set_shortcut_and_tooltip
...
class UIBuilder:
    ...
    def _create_actions(self):
        ...
        set_shortcut_and_tooltip(mw.new_action, "Ctrl+Shift+N")

        mw.new_file_action = QAction(get_standard_icon(QStyle.StandardPixmap.SP_FileLinkIcon, "NewFile"), "New &File...", mw)
        mw.new_file_action.setStatusTip("Create a new diagram file")
        set_shortcut_and_tooltip(mw.new_file_action, "Ctrl+N")
        ...
        mw.open_action.setShortcut(QKeySequence.StandardKey.Open) # Standard keys are already platform-aware
        ...
        mw.save_as_action = QAction(get_standard_icon(QStyle.StandardPixmap.SP_DriveHDIcon, "SA"), "Save File &As...", mw)
        ...
        mw.export_png_action = QAction(get_standard_icon(QStyle.StandardPixmap.SP_MediaSave, "Img"), "&PNG Image...", mw)
        mw.export_svg_action = QAction(get_standard_icon(QStyle.StandardPixmap.SP_MediaSave, "Img"), "&SVG Image...", mw)
        ...
        mw.export_c_testbench_action = QAction(get_standard_icon(QStyle.StandardPixmap.SP_FileIcon, "Test"), "C &Testbench...", mw, statusTip="Generate a C test harness for the FSM")
        mw.export_vhdl_action = QAction(get_standard_icon(QStyle.StandardPixmap.SP_DriveNetIcon, "HDL"), "&VHDL Code...", mw, statusTip="Export the FSM as synthesizable VHDL code")
        mw.export_verilog_action = QAction(get_standard_icon(QStyle.StandardPixmap.SP_DriveNetIcon, "HDL"), "&Verilog Code...", mw, statusTip="Export the FSM as synthesizable Verilog code")
        ...
        mw.select_all_action.setShortcut(QKeySequence.StandardKey.SelectAll)
        mw.find_item_action = QAction("&Find Item...", mw)
        mw.find_item_action.setShortcut(QKeySequence.StandardKey.Find)
        ...
        def create_mode_action(name, text, icon_enum, shortcut_key):
            action = QAction(get_standard_icon(icon_enum, shortcut_key), text, mw)
            action.setCheckable(True)
            set_shortcut_and_tooltip(action, shortcut_key)
            mw.mode_action_group.addAction(action)
            return action
        mw.select_mode_action = create_mode_action("select", "Select/Move", QStyle.StandardPixmap.SP_ArrowRight, "S")
        mw.add_state_mode_action = create_mode_action("state", "Add State", QStyle.StandardPixmap.SP_FileDialogNewFolder, "A")
        mw.add_transition_mode_action = create_mode_action("transition", "Add Transition", QStyle.StandardPixmap.SP_ArrowForward, "T")
        mw.add_comment_mode_action = create_mode_action("comment", "Add Comment", QStyle.StandardPixmap.SP_MessageBoxInformation, "C")
        ...
        # --- View Actions ---
        mw.zoom_in_action = QAction("Zoom In", mw); mw.zoom_in_action.setShortcut(QKeySequence.StandardKey.ZoomIn)
        mw.zoom_out_action = QAction("Zoom Out", mw); mw.zoom_out_action.setShortcut(QKeySequence.StandardKey.ZoomOut)
        mw.reset_zoom_action = QAction("Reset Zoom/View", mw); set_shortcut_and_tooltip(mw.reset_zoom_action, "Ctrl+0")
        ...
        mw.auto_layout_action = QAction("Auto-Layout Diagram", mw); set_shortcut_and_tooltip(mw.auto_layout_action, "Ctrl+L")
