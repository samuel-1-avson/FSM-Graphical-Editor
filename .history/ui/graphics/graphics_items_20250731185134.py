...
class TransitionPulseItem(QObject, QGraphicsEllipseItem):
    ...
    def __init__(self, parent_transition):
        # Correctly initialize multi-inherited classes
        QObject.__init__(self)
        QGraphicsEllipseItem.__init__(self, -5, -5, 10, 10)
        
        # Set QGraphicsItem parent after both initializations
    ...
    # Define a QProperty that can be targeted by QPropertyAnimation
...
class GraphicsTransitionItem(QGraphicsPathItem):
    ...
    def start_pulse_animation(self):
        ...
        # The scene automatically takes ownership of the item when added
        ...
        # Connect the finished signal to a cleanup lambda. This ensures the pulse
        # item is removed from the scene after the animation completes.
