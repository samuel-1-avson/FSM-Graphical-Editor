...
from PyQt6.QtWidgets import (
    ...
    QGraphicsRectItem, QInputDialog, QRubberBand
)
...
class DiagramScene(QGraphicsScene):
    ...
    def dragEnterEvent(self, event: QGraphicsSceneDragDropEvent):
        if event.mimeData().hasFormat(MIME_TYPE_BSM_ITEMS) or \
    ...
    def dropEvent(self, event: QGraphicsSceneDragDropEvent):
        ...
        if mime_data.hasFormat(MIME_TYPE_BSM_ITEMS):
            item_type_data_str = mime_data.data(MIME_TYPE_BSM_ITEMS).data().decode('utf-8')
