...
class GraphicsTransitionItem(QGraphicsPathItem):
    ...
    def paint(self, painter: QPainter, option, widget):
        ...
        if current_label:
            ...
            label_rect_width = 150; text_block_rect = QRectF(0, 0, label_rect_width, 100); text_rect_original = fm.boundingRect(text_block_rect.toRect(), int(Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.TextWordWrap), current_label)
            ...
            painter.setPen(self._text_color); painter.drawText(text_final_draw_rect, int(Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.TextWordWrap), current_label)
