...
class GraphicsStateItem(QGraphicsRectItem):
    ...
    def paint(self, painter: QPainter, option, widget):
        ...
        if not self._is_editing_inline:
            ...
            # --- FIX: PyQt6 uses integer flags. TextWordWrap is now default for drawText in a rect. ---
            flags = int(Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.TextWordWrap)
...
class GraphicsTransitionItem(QGraphicsPathItem):
    ...
    def paint(self, painter: QPainter, option, widget):
        ...
        if current_label:
            ...
            # --- FIX: Use integer flags and remove TextWordWrap ---
            flags = int(Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.TextWordWrap)
            ...
            painter.setPen(self._text_color)
            # --- FIX: Use integer flags here as well ---
