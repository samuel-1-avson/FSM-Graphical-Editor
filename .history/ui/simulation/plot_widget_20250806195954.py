# fsm_designer_project/ui/simulation/plot_widget.py
    ...
    def update_variable_list(self, variables: dict):
        ...
        for var_name, value in variables.items():
            if isinstance(value, (int, float, bool)):
                ...
                item.setCheckState(Qt.CheckState.Checked if var_name in self.plotted_variables else Qt.CheckState.Unchecked)
