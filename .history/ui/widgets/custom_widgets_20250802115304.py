...
class CollapsibleSection(QFrame):
    ...
    def _create_header(self):
        ...
        self.header.setText(self.title_text)
    ...
    def _apply_styling(self):
        ...
        header_style = f"""
            ...
            QToolButton:hover {{
                background-color: {COLOR_DRAGGABLE_BUTTON_HOVER_BG};
                border-color: {COLOR_DRAGGABLE_BUTTON_HOVER_BORDER};
            }}
            QToolButton:pressed {{
                background-color: {COLOR_DRAGGABLE_BUTTON_PRESSED_BG};
            }}
        ...
        style = f"""
            QToolButton#DraggableToolButton {{
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
                    stop:0 {COLOR_DRAGGABLE_BUTTON_BG}, 
                    stop:1 {COLOR_BACKGROUND_MEDIUM});
                border: 2px solid {COLOR_DRAGGABLE_BUTTON_BORDER};
                border-radius: 6px;
                padding: 8px 12px;
                font-weight: 500;
                color: {COLOR_TEXT_PRIMARY};
            ...
            QToolButton#DraggableToolButton:hover {{
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
                    stop:0 {COLOR_DRAGGABLE_BUTTON_HOVER_BG}, 
                    stop:1 {COLOR_DRAGGABLE_BUTTON_BG});
                border-color: {COLOR_DRAGGABLE_BUTTON_HOVER_BORDER};
                color: {COLOR_TEXT_PRIMARY};
            }}
            
            QToolButton#DraggableToolButton:pressed {{
                background: {COLOR_DRAGGABLE_BUTTON_PRESSED_BG};
                border-color: {COLOR_DRAGGABLE_BUTTON_HOVER_BORDER};
