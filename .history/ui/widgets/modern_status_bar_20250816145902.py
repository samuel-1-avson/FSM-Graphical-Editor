...
class StatusIndicator(QWidget):
    ...
    def set_status(self, text, status_type="info"):
        ...
        colors = {
            "info": theme_config.COLOR_ACCENT_PRIMARY,
            "success": theme_config.COLOR_ACCENT_SUCCESS,
            "warning": theme_config.COLOR_ACCENT_WARNING,
            "error": theme_config.COLOR_ACCENT_ERROR
        }
        
        color = colors.get(status_type, theme_config.COLOR_ACCENT_PRIMARY)
        bg_color = QColor(color).lighter(190)
        luminance = bg_color.lightnessF()
        text_color = theme_config.COLOR_TEXT_PRIMARY if luminance > 0.5 else theme_config.COLOR_TEXT_ON_ACCENT
    ...
    def update_performance(self):
        ...
        try:
            ...
            try:
                ...
                if cpu_percent > 80: color = theme_config.COLOR_ACCENT_ERROR
                elif cpu_percent > 60: color = theme_config.COLOR_ACCENT_WARNING
                else: color = theme_config.COLOR_ACCENT_SUCCESS
