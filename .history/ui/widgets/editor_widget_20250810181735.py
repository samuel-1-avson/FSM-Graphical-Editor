# fsm_designer_project/ui/widgets/editor_widget.py
...
class EditorWidget(QWidget):
    ...
    """
    def __init__(self, main_window_ref, asset_manager: AssetManager):
        ...
        self.scene = DiagramScene(self.undo_stack, parent_window=self.mw, asset_manager=asset_manager)
