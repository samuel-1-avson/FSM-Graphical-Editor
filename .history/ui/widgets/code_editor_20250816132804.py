...
class CodeEditor(QPlainTextEdit):
    def __init__(self, parent=None):
        ...
        editor_font_size = 10 
        try:
            editor_font_size_val = int(config.APP_FONT_SIZE_EDITOR.replace("pt", ""))
        ...
        palette.setColor(QPalette.ColorRole.Base, QColor(theme_config.COLOR_BACKGROUND_EDITOR_DARK))
        palette.setColor(QPalette.ColorRole.Text, QColor(theme_config.COLOR_TEXT_EDITOR_DARK_PRIMARY))
    ...
    def lineNumberAreaPaintEvent(self, event):
        ...
        line_number_area_bg = QColor(theme_config.COLOR_BACKGROUND_EDITOR_DARK).lighter(110)
        ...
        current_line_highlight_bg = QColor(theme_config.COLOR_BACKGROUND_EDITOR_DARK).lighter(130)
        current_line_num_color = QColor(theme_config.COLOR_ACCENT_PRIMARY_LIGHT) 
        normal_line_num_color = QColor(theme_config.COLOR_TEXT_EDITOR_DARK_SECONDARY) 
    ...
    def highlightCurrentLine(self):
        ...
        if not self.isReadOnly():
            ...
            lineColor = QColor(theme_config.COLOR_BACKGROUND_EDITOR_DARK).lighter(120)
...
class PythonHighlighter(QSyntaxHighlighter):
    def __init__(self, parent=None): 
        ...
        operatorFormat.setForeground(QColor(theme_config.COLOR_TEXT_EDITOR_DARK_PRIMARY).lighter(110)) 
        operators_regex = (
