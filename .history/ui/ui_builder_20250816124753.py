...
class UIBuilder:
    ...
    def _create_ribbon(self):
        ...
        file_group.add_action_button(mw.new_action)
        file_group.add_action_button(mw.new_file_action)
        file_group.add_action_button(mw.open_action)
    ...
    def _create_docks(self):
        ...
        # --- NEW: Populate these docks directly here since they are now static ---
