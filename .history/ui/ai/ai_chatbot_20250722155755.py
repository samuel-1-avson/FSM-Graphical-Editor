    ...
    def _prepare_system_prompt(self, user_message: str, force_fsm_generation: bool) -> str:
        ...
        if is_fsm_generation_attempt:
            ...
            system_prompt_content += (
                ...
                "Valid actions are 'add_state', 'add_transition', 'rename_state', 'delete_item'. "
...
class AIChatUIManager(QObject):
    ...
    applyFixRequested = pyqtSignal(dict) # Re-purposed for all AI actions
    ...
    def __init__(self, main_window, parent=None):
        ...
        # --- NEW: A simple cache to prevent re-asking for the same action ---
    ...
    def connect_signals(self):
        ...
        if ask_fsm_action and isinstance(ask_fsm_action, QAction):
            ...
            logger.error("AIChatUIManager: Could not find 'ask_ai_to_generate_fsm_action' on MainWindow.")
        ...
        if clear_chat_action and isinstance(clear_chat_action, QAction):
            ...
            logger.error("AIChatUIManager: Could not find 'clear_ai_chat_action' on MainWindow.")
    ...
    def _connect_ai_chatbot_signals(self):
        if self.mw.ai_chatbot_manager:
            ...
            # --- NEW: Connect the action proposal signal ---
