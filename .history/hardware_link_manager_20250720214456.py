...
class HardwareLinkManager(QObject):
    ...
    hardwareEventReceived = pyqtSignal(str) # Emits the name of the component that triggered an event
    hardwareLinkLost = pyqtSignal() # Emitted on unexpected disconnect
    ...
    def __init__(self, main_window):
        ...
        self._reconnection_timer.setInterval(3000) # Try to reconnect every 3 seconds
