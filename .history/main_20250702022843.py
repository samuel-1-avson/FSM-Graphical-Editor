...
class MainWindow(QMainWindow):
    ...
    # --- FIX: REMOVED THE REDUNDANT AND BUGGY STUB METHODS ---
    # The following blocks of lambda and pass methods were removed as they
    # were overriding the actual method implementations defined later in the class,
    # leading to unexpected behavior and crashes.
