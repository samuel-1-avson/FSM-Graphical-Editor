...
### `fsm_designer_project/dialogs.py` (Updated)
...
class TransitionPropertiesDialog(QDialog):
    ...
    def _on_ai_helper_clicked(self, target_widget, code_type):
        ...
        # The following message is now handled by the response handler in AIChatUIManager
        # QMessageBox.information(self, "AI Request Sent", "Your request has been sent to the AI assistant. Please copy the generated code from the main AI Chat window into the text field.")
