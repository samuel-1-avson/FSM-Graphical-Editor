...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.settings_manager = QApplication.instance().settings_manager    
        self.theme_manager = ThemeManager() # Initialize theme manager
        ...
        self.theme_manager.themesChanged.connect(self._populate_perspectives_menu)
        # -- NEW PERSPECTIVE MANAGER --
        # This replaces the perspective-related attributes previously on self.mw
    ...
    def _apply_theme(self, theme_name: str):
        ...
        # --- NEW: Get theme data dictionary from the manager ---
        ...
        # --- FIX: Pass the dictionary, not the name string ---
    ...
    # NEW methods for Git Integration
    def _update_git_menu_actions_state(self):
        editor = self.current_editor()
        is_in_repo = False
        if editor and editor.file_path:
             # This check is now robust and cheap due to the cache in GitManager
             file_dir = os.path.dirname(editor.file_path)
             if self.git_manager and file_dir in self.git_manager._repo_root_cache:
