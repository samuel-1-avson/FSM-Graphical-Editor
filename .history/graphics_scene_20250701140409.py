...
class DiagramScene(QGraphicsScene):
    ...
    def _add_item_interactive(self, pos: QPointF, item_type: str, name_prefix:str="Item", initial_data:dict=None):
        ...
        if item_type == "State":
            ...
            # ... (initial_dialog_props setup is unchanged) ...
            ...
            if props_dialog.exec() == QDialog.Accepted:
                ...
                # Simplified and more robust check for any existing state with the chosen name.
                if self.get_state_by_name(final_props['name']):
                    ...
                    # If the name is unique, proceed to create the state.
