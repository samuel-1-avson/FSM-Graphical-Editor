...
class MainWindow(QMainWindow):
    ...
    def _update_properties_dock(self):
        ...
        if len(selected_items) > 1:
            self.properties_placeholder_label.setText(f"<i><b>{len(selected_items)} items selected.</b><br><span style='font-size:{config.APP_FONT_SIZE_SMALL}; color:{config.COLOR_TEXT_SECONDARY};'>Select a single item to edit properties.</span></i>")
