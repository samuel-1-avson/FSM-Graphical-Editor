...
class AiSettingsDialog(QDialog):
    """New dialog to select AI provider and enter API key."""
    def __init__(self, settings_manager, parent=None):
        ...
        self.on_provider_changed(self.provider_combo.currentText()) # Load initial key
...
class AIChatbotManager(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.api_key = self.parent_window.settings_manager.get("ai_api_key", None)
