...
from PyQt5.QtCore import (
    Qt, QTimer, QPoint, QUrl, pyqtSignal, pyqtSlot, QSize, QIODevice, QFile, QSaveFile, QDesktopServices
)
...
class MainWindow(QMainWindow):
    ...
    def _update_live_preview(self):
        ...
        if preview_type == "PlantUML":
            ...
            preview_text = generate_plantuml_text(diagram_data) if diagram_data and diagram_data['states'] else "// No states to generate PlantUML."
        elif preview_type == "Mermaid":
            from .export_utils import generate_mermaid_text
            preview_text = generate_mermaid_text(diagram_data) if diagram_data and diagram_data['states'] else "%% No states to generate Mermaid."
    ...
    def _update_matlab_status_display(self, connected, message):
        ...
        if hasattr(self, 'matlab_status_label') and self.matlab_status_label:
            ...
            self.matlab_status_label.parentWidget().setToolTip(tooltip_text) # Tooltip on parent widget too
