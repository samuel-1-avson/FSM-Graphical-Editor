...
from .managers.project_manager import PROJECT_FILE_EXTENSION
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        # --- MANAGER & SERVICE INITIALIZATION (ORDER IS IMPORTANT) ---
        ...
        # --- Managers (Internal State & Orchestration) ---
        ...
        self.action_handler = ActionHandler(self) # Now a coordinator
        self.ui_manager = UIManager(self) # Now a UI state manager
        ...
        # --- UI CONSTRUCTION (New Step) ---
        builder = UIBuilder(self)
        builder.build_ui()
        # The UIManager needs to know about the CSimulationManager, which is built by the UIBuilder
        ...
        # --- Post-Build Population and Connections ---
    ...
    def _connect_application_signals(self):
        ...
        # --- MODIFIED: Connect to the signal bus ---
