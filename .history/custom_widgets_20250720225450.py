...
class CollapsibleSection(QFrame):
    ...
    def init_ui(self, title):
        ...
        # --- NEW: Store the title label for access by filter ---
        self.title_label = self.header.findChild(QLabel)
    ...
    def add_widget(self, widget: QWidget):
        ...
        # For widgets without a label (like a checkbox), we still wrap it
        # to ensure consistent structure for filtering.
        if not isinstance(widget, QCheckBox):
            ...
            # The checkbox itself serves as its label
            widget.setObjectName("propertyLabel")
