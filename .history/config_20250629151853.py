...
# --- Configuration ---
APP_VERSION = "1.9.0" # Incremented version for Theme Manager
...
# --- NEW: Hardcoded default theme data dictionaries ---
THEME_DATA_LIGHT = {
...
# --- Dynamic Color Variables (populated by DYNAMIC_UPDATE_COLORS_FROM_THEME) ---
# Initialize with placeholders to ensure the variables exist.
for key in THEME_KEYS:
    globals()[key] = ""
    
# Initialize other colors that might be derived
...
# --- REFACTORED: Function to update colors from a data dictionary ---
def DYNAMIC_UPDATE_COLORS_FROM_THEME(theme_data: dict):
    """Updates the global color variables from a given theme data dictionary."""
    ...
    # Update derived colors based on the new global values
...
# Initial call to set default (Light) theme colors on module import
...
def GET_CURRENT_STYLE_SHEET():
    ...
    QTextBrowser#AIChatDisplay QScrollBar::handle:vertical, QPlainTextEdit#ActionCodeEditor QScrollBar:vertical,
