...
class TransitionPulseItem(QObject, QGraphicsEllipseItem):
    def __init__(self, parent_transition):
        ...
        # The original super().__init__ call was ambiguous and would pass integer
        # arguments to QObject's constructor, causing a crash.
        QObject.__init__(self, parent=parent_transition)
