...
class MainWindow(QMainWindow):
    ...
    def _apply_theme(self, theme_name: str):
        ...
        # In TDI, we must iterate through all scenes
    ...
    def _connect_signals(self):
        ...
        self.tab_widget.tabCloseRequested.connect(self._on_close_tab_requested) # New signal for closing tabs
        ...
        # Resource Estimation Dock Connection
    ...
    def _connect_editor_signals(self, editor: EditorWidget):
        ...
        if hasattr(editor.scene, 'itemsBoundingRectChanged'): # For resource estimation
             editor.scene.itemsBoundingRectChanged.connect(self.update_resource_estimation)
        if hasattr(editor.scene, 'sceneRectChanged'): # Also for resource estimation
    ...
    def _apply_initial_settings(self):
        ...
        # The scene now reads its own settings when it is created.
        # We just need to sync the UI toggle actions in the main window to reflect the settings.
        ...
        # No self.scene exists yet, so we cannot call update() on it.
        # This is fine, as the first scene created will read these settings.
