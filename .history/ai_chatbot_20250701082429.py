...
class AIChatUIManager(QObject):
    ...
    def _append_to_chat_display(self, sender: str, message: str):
        ...
        elif sender in ["Diagram", "Validation Helper", "IDE"]:
        ...
        elif sender in ["Diagram", "Validation Helper", "IDE"]: bg_msg_color = QColor(sender_color_str).lighter(190).name()
...
class AIChatbotManager(QObject):
    ...
    def _prepare_and_send_to_worker(self, user_message_text: str, is_fsm_gen_specific: bool = False, is_inline_code_request: bool = False):
        ...
        if self.chatbot_worker:
            ...
            # For inline code requests, we don't force FSM generation format.
