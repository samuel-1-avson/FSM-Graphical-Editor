...
class AnimationManager(QObject):
    ...
    def _create_energy_flow_particles(self, from_state: str, to_state: str):
        ...
        for i in range(flow_count):
            ...
            for j in range(3):  # 3 particles per group
                particle = QGraphicsEllipseItem(-1.5, -1.5, 3, 3)
    ...
    def _create_consumption_particles(self, position_index: int):
        ...
        for i in range(particle_count):
            ...
            particle = QGraphicsEllipseItem(-1, -1, 2, 2)
    ...
    def _create_intensive_error_effects(self, state_item):
        ...
        # Error ring
        error_ring = QGraphicsEllipseItem(rect.adjusted(-20, -20, 20, 20))
    ...
    def _create_enhanced_breakpoint_effects(self, state_item):
        ...
        bp_ring = QGraphicsEllipseItem(rect.adjusted(-12, -12, 12, 12))
    ...
    def cleanup_finished_animations(self):
        """Removes references to animations that have finished."""
        finished_keys = [key for key, info in self.active_animations.items() if info['animation'].state() == QAbstractAnimation.Stopped]
