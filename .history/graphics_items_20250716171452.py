# fsm_designer_project/graphics_items.py
import math
import os
import sip
...
class TransitionPulseItem(QObject, QGraphicsEllipseItem):
    def __init__(self, parent_transition):
        # --- FIX: Explicitly call base class constructors. ---
        # Call QObject's constructor first. It does not take a Qt parent in this
        # context, as its lifetime is managed by the QGraphicsItem hierarchy.
        QObject.__init__(self)
        
        # Call QGraphicsEllipseItem's constructor, passing the item's dimensions
        # and its graphical parent (the GraphicsTransitionItem).
        QGraphicsEllipseItem.__init__(self, -5, -5, 10, 10, parent=parent_transition)
