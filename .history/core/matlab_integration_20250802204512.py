...
class MatlabConnection(QObject):
    ...
    def ensure_connection_and_execute(self, command: MatlabCommand):
        ...
        if self.is_connected():
            ...
            # If not connected, connect first, then execute the command once connected.
            # The singleShot connection ensures this callback only fires once for this command.
