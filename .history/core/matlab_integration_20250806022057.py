...
class MatlabConnection(QObject):
    ...
    def _on_command_finished(self, success: bool, message: str, data: str, 
        ...
        # Route to appropriate signals with metadata
    ...
    def generate_simulink_model(self, states: List[Dict], transitions: List[Dict], 
        ...
        script_content = self._create_enhanced_model_generation_script(
            states, transitions, str(slx_file_path), model_name, options
        )
        ...
        command = MatlabCommand(
            ...
            timeout=120.0,  # Extended timeout for complex models
