...
class FSMSimulator:
    ...
    def __init__(self, states_data: List[Dict[str, Any]], transitions_data: List[Dict[str, Any]], halt_on_action_error: bool = False):
        ...
        # --- MODIFIED: Add 'transitions' to the breakpoints dictionary ---
        ...
        while events_to_process and not transition_taken_this_step:
            ...
            for i in range(len(self.current_state_path) - 1, -1, -1):
                ...
                for trans in self.transitions:
                    ...
                    if condition_ok:
                        # --- NEW: TRANSITION BREAKPOINT CHECK ---
    ...
    def add_transition_breakpoint(self, source: str, target: str, event: str):
        """Adds a breakpoint for a specific transition."""
        self.breakpoints['transitions'].add((source, target, event))

    def remove_transition_breakpoint(self, source: str, target: str, event: str):
