...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # --- START OF FIX: REORDER INITIALIZATION ---
        
        # self.action_handler = ActionHandler(self) # DELETE THIS LINE FROM HERE
        ...
        # 1. UIManager must be created and run FIRST. This creates the QAction objects.
        self.ui_manager = UIManager(self)
        self.ui_manager.setup_ui()

        # 2. Now that self.new_action etc. exist, we can create the ActionHandler.
