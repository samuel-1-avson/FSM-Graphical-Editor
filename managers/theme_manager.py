...
# --- ADDED: Import the config module ---
...
class ThemeManager(QObject):
    ...
    THEME_DATA_LIGHT = {
        ...
        "COLOR_ITEM_TRANSITION_DEFAULT": "#27AE60", "COLOR_ITEM_COMMENT_BG": "#FFFFFF",
    ...
    THEME_DATA_DARK = {
        ...
        "COLOR_ITEM_TRANSITION_DEFAULT": "#73C991", "COLOR_ITEM_COMMENT_BG": "#3E3E42",
    ...
    THEME_DATA_MONOCHROME = {
        ...
        "COLOR_ITEM_TRANSITION_DEFAULT": "#6C757D", "COLOR_ITEM_COMMENT_BG": "#F8F9FA",
    ...
    THEME_DATA_PROFESSIONAL_BLUE = {
        ...
        "COLOR_ITEM_TRANSITION_DEFAULT": "#059669", "COLOR_ITEM_COMMENT_BG": "#FFFFFF",
    ...
    THEME_DATA_PROFESSIONAL_DARK = {
        ...
        "COLOR_ITEM_TRANSITION_DEFAULT": "#10B981", "COLOR_ITEM_COMMENT_BG": "#334155",
    ...
    THEME_DATA_MINIMAL_GRAY = {
        ...
        "COLOR_ITEM_TRANSITION_DEFAULT": "#757575", "COLOR_ITEM_COMMENT_BG": "#FFFFFF",
    ...
    THEME_DATA_CORPORATE = {
        ...
        "COLOR_ITEM_TRANSITION_DEFAULT": "#137333", "COLOR_ITEM_COMMENT_BG": "#FFFFFF",
    ...
    def get_current_stylesheet(self, theme_data: Dict[str, str]) -> str:
        ...
        /* === Professional Ribbon Styling === */
        QFrame#RibbonContentArea {{
            background-color: {theme_data['COLOR_BACKGROUND_APP']};
            border-bottom: 1px solid {theme_data['COLOR_BORDER_LIGHT']};
        }}
        
        QWidget#RibbonTabBar {{
            background-color: {theme_data['COLOR_BACKGROUND_APP']};
            border-bottom: 1px solid {theme_data['COLOR_BORDER_LIGHT']};
        }}
        ...
        QToolButton#FileButton:hover {{ 
            background-color: {QColor(theme_data['COLOR_ACCENT_PRIMARY']).darker(110).name()};
        }}
        QToolButton#FileButton:pressed, QToolButton#FileButton:checked {{ 
            background-color: {QColor(theme_data['COLOR_ACCENT_PRIMARY']).darker(120).name()};
        }}
        ...
        QPushButton#RibbonTabButton:hover {{ 
            background-color: {theme_data['COLOR_ACCENT_PRIMARY_LIGHT']};
            color: {theme_data['COLOR_TEXT_PRIMARY']};
        }}
        ...
        QFrame#RibbonSeparator {{
            background-color: {theme_data['COLOR_BORDER_LIGHT']};
        }}

        QLineEdit#RibbonSearchBar {{
            background-color: {QColor(theme_data['COLOR_BACKGROUND_APP']).lighter(105).name()};
            border: 1px solid {theme_data['COLOR_BORDER_LIGHT']};
        }}
        """
    ...
    def update_dynamic_config_colors(self, theme_data: dict):
        """
        Populates the global theme_config object with colors from the provided theme data.
        This is now the single point of update for all theme-related colors.
        """
        theme_config.update_from_dict(theme_data)
        logger.debug("Updated global theme_config object with new theme data.")
