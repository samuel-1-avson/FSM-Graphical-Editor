...
class RecentFileItem(QFrame):
    ...
    def update_styles(self):
        ...
        """)
        self.name_label.setStyleSheet(f"color: {theme_config.COLOR_TEXT_PRIMARY}; font-weight: bold;")
        self.path_label.setStyleSheet(f"color: {theme_config.COLOR_TEXT_SECONDARY}; font-size: 8pt;")
...
class ModernWelcomeScreen(QWidget):
    ...
    def update_styles(self):
        ...
        """)
        self.title_label.setStyleSheet(f"color: {theme_config.COLOR_ACCENT_PRIMARY}; font-size: 32pt; font-weight: bold; padding: 20px;")
        self.version_label.setStyleSheet(f"color: {theme_config.COLOR_TEXT_SECONDARY}; font-size: 12pt;")
        self.tagline_label.setStyleSheet(f"color: {theme_config.COLOR_TEXT_PRIMARY}; font-size: 14pt; padding: 10px;")
        self.recent_label.setStyleSheet(f"color: {theme_config.COLOR_TEXT_PRIMARY}; font-size: 16pt; font-weight: bold;")
        self.no_recent_label.setStyleSheet(f"color: {theme_config.COLOR_TEXT_SECONDARY}; font-style: italic; padding: 40px; background-color: {theme_config.COLOR_BACKGROUND_LIGHT}; border: 1px solid {theme_config.COLOR_BORDER_LIGHT}; border-radius: 8px;")
        self.footer_label.setStyleSheet(f"color: {theme_config.COLOR_TEXT_SECONDARY}; font-size: 9pt; padding: 20px;")
